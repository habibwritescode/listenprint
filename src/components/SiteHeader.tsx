...
export function SiteHeader() {
  ...
  return (
    <header
      ...
      className="sticky top-0 z-20 -mx-4 flex items-center justify-between gap-4 border-b border-border px-4 py-4 transition-[translate,background-color] duration-200 data-hidden:not-focus-within:-translate-y-full data-scrolled:bg-bg/90 data-scrolled:backdrop-blur motion-reduce:transition-none sm:-mx-8 sm:px-8"
    >
